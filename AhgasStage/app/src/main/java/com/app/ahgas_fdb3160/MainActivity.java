...
import com.app.ahgas_fdb3160.util.LocationUtil;
import com.app.ahgas_fdb3160.util.LogUtil;
import com.app.ahgas_fdb3160.util.PrefsUtil;
import com.app.ahgas_fdb3160.util.Utils;
import com.app.ahgas_fdb3160.volley.CustomRequest;
import com.app.ahgas_fdb3160.volley.VolleyLibrary;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String gdGroupHash = "fdb3160233540adb154c5badbd6b0786";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        header.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if (ContextCompat.checkSelfPermission(MainActivity.this, Manifest.permission.BLUETOOTH_ADMIN) != PackageManager.PERMISSION_GRANTED) {
    ...
    private void openWeightMeasureScreen() {
        Intent weight = new Intent(this, WeightMeasure.class);
