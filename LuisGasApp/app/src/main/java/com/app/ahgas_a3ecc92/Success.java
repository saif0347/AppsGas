...
public class Success extends AppCompatActivity {
    ...
    private void rateUser() {
        showLoader();
        String url = com.app.ahgas_a3ecc92.MainActivity.baseUrl + "/partner/"+PrefsUtil.getHashId(this)+"/review";
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if(status > 0){
                                ...
                                finishAffinity();
                                Intent repeat = new Intent(Success.this, com.app.ahgas_a3ecc92.MainActivity.class);
